...
print("RÁDIO LUZ GOSPEL - ROBÔ DE NOTÍCIAS 8.6")
    ...
    try:
        while True:
            ...
            for post in data.get("items", []):
                ...
                # Posts 8.6: a URL fica somente em comentário HTML invisível.
                for match in re.findall(
...
def main():
    print("News Gospel + UAU Gospel + Folha Gospel Música + Guiame Música | Versão 8.6")
...
# ============================================================
# VERSÃO 8.6 - coleta, redação original, deduplicação e log enxuto
# ============================================================
MAX_AGE_DAYS = 30
VERSION = "8.6"
...
s = requests.Session()
s.headers.update({"User-Agent": "Mozilla/5.0 (compatible; RadioLuzGospelBot/8.6)"})
...
print("VERSÃO 8.6 ATIVA: log enxuto | Folha Gospel Música + Guiame Música | fonte sem URL | originalidade e deduplicação")
selfbot.main()
