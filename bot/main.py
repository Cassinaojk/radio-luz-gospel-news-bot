...
print("RÁDIO LUZ GOSPEL - ROBÔ DE NOTÍCIAS 8.5")
    ...
    try:
        while True:
            ...
            for post in data.get("items", []):
                ...
                # Posts 8.5: a URL fica somente em comentário HTML invisível.
                for match in re.findall(
...
def main():
    print("News Gospel + UAU Gospel + Folha Gospel Música + Guiame Música | Versão 8.5")
    ...
    while candidates and published < MAX_POSTS_PER_RUN:
        ...
        if gemini_calls >= MAX_GEMINI_TEXT_CALLS_PER_RUN:
            print("⚠ Gemini: limite desta execução atingido")
            break
...
# ============================================================
# VERSÃO 8.5 - coleta, redação original, deduplicação e log enxuto
# ============================================================
MAX_AGE_DAYS = 30
VERSION = "8.5"
...
print("VERSÃO 8.5 ATIVA: log enxuto | Folha Gospel Música + Guiame Música | fonte sem URL | originalidade e deduplicação")
selfbot.main()
