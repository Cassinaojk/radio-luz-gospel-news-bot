...
print("RÁDIO LUZ GOSPEL - ROBÔ DE NOTÍCIAS 8.4")
...
print("VERSÃO 8.4 ATIVA: log enxuto | Folha Gospel Música + Guiame Música | fonte sem URL | originalidade e deduplicação")
selfbot.main()
